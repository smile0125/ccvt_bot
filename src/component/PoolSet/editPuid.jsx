...
class EditWeChat extends Component {
    ...
    componentWillMount() {
        if (this.props.location.query) {
            const manager_wechat_id = this.props.location.query.manager_wechat_id;
            this.setState({ manager_wechat_id: manager_wechat_id });
        }
    }
    groupNameChange = (e) => {
    ...
    modiyGroupName = () => {
        const params = { token: GetCookie('token'), manager_wechat_id: this.state.manager_wechat_id, group_id: GetCookie('group_id') }
